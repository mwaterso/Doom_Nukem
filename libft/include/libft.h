...
void       			ft_putstr_hexa(char *str, t_putstr_style type, uint32_t color);
void       			ft_putendl_hexa(char *str, t_putstr_style type, uint32_t color);
void       			ft_putnbr_hexa(int nbr, t_putstr_style type, uint32_t color);
