...
void				*ft_memset(void *str, int c, ssize_t len);
void				*ft_memrcpy(void *dest, const void *src, ssize_t len);
void				*ft_memcpy(void *dest, const void *src, ssize_t len);
void				*ft_memccpy(void *dest, const void *src, int c, ssize_t len);
void				*ft_memmove(void *dest, const void *src, ssize_t len);
void				*ft_memchr(const void *str, int c, ssize_t len);
void				*ft_memalloc(ssize_t len);
void				ft_bzero(void *str, ssize_t len);
...
int					ft_memcmp(const void *s1, const void *s2, ssize_t len);
int					ft_atoi(const char *str);
int					ft_strcmp(const char *s1, const char *s2);
int					ft_strncmp(const char *s1, const char *s2, ssize_t len);
int					ft_strequ(char const *s1, char const *s2);
int					ft_strnequ(char const *s1, char const *s2, ssize_t len);
...
char				*ft_strncpy(char *dest, const char *src, ssize_t len);
char				*ft_strstr(const char *src, const char *s2);
char				*ft_strnstr(const char *src, const char *s2, ssize_t len);
char				*ft_strcat(char *dest, const char *src);
char				*ft_strncat(char *dest, const char *src, ssize_t len);
...
ssize_t				ft_strlcat(char *dest, const char *src, ssize_t len);
