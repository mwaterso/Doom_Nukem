...
/*   Updated: 2020/02/20 16:26:39 by calin            ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->mlx_addrs = mlx_init();
	data->win_addrs = mlx_new_window(data->mlx_addrs, WIN_SIZE_W, WIN_SIZE_H,
	"Doom-Nukem");
...
{
	mlx_destroy_image(data->mlx_addrs, data->tab_tex[0].img.addrs);
	if (data->weaponanim.index_rld_anim == 0)
		data->name_texture[0] = "hud/images/rld.xpm";
	if (data->weaponanim.index_rld_anim == 1)
		data->name_texture[0] = "hud/images/rld1.xpm";
	if (data->weaponanim.index_rld_anim == 2)
		data->name_texture[0] = "hud/images/rld2.xpm";
	if (data->weaponanim.index_rld_anim == 3)
		data->name_texture[0] = "hud/images/wpn3.xpm";
	...
	data->tab_tex[0].img.addrs, 1000, 500);
...
void	weapon_animation(t_data *data)
{
	...
	if (data->weaponanim.index_wpn_anim == 0)
		data->name_texture[0] = "hud/images/wpn7.xpm";
	if (data->weaponanim.index_wpn_anim == 1)
		data->name_texture[0] = "hud/images/wpn6.xpm";
	if (data->weaponanim.index_wpn_anim == 2)
		data->name_texture[0] = "hud/images/wpn5.xpm";
	if (data->weaponanim.index_wpn_anim == 3)
		data->name_texture[0] = "hud/images/wpn4.xpm";
	if (data->weaponanim.index_wpn_anim == 4)
		data->name_texture[0] = "hud/images/wpn3.xpm";
	if (data->weaponanim.index_wpn_anim == 5)
		data->name_texture[0] = "hud/images/wpn2.xpm";
	data->tab_tex[0].img.addrs = mlx_xpm_file_to_image(data->mlx_addrs,
	data->name_texture[0], &data->tab_tex[0].width, &data->tab_tex[0].height);
	data->tab_tex[0].img.tab =
	(int *)mlx_get_data_addr(data->tab_tex[0].img.addrs,
