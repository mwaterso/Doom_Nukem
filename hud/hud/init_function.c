...
/*   Updated: 2020/02/20 16:28:34 by calin            ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int		heal_texture_animation(t_data *data)
{
	...
	data->healanim.tab_texture[0] = "hud/images/healanim1.xpm";
	data->healanim.tab_texture[1] = "hud/images/healanim2.xpm";
	data->healanim.tab_texture[2] = "hud/images/healanim3.xpm";
	data->healanim.tab_texture[3] = "hud/images/healanim4.xpm";
	i = -1;
	while (++i < NB_ANIM_TEX)
	{
		if (!(data->healanim.anim_texture[i].img.addrs =
		...
		(int *)mlx_get_data_addr(data->healanim.anim_texture[i].img.addrs,
		&(data->healanim.anim_texture[i].img.bpp),
...
int		load_menu_texture(t_data *data)
{
	...
	data->menu_texture[0].name_text = "hud/images/bg_menu.xpm";
	data->menu_texture[0].pos_text = (t_dot){.x = 0, .y = 0};
	data->menu_texture[1].name_text = "hud/images/play.xpm";
	data->menu_texture[1].pos_text = (t_dot){.x = 600, .y = 400};
	data->menu_texture[2].name_text = "hud/images/editor.xpm";
	data->menu_texture[2].pos_text = (t_dot){.x = 600, .y = 550};
	data->menu_texture[3].name_text = "hud/images/exit.xpm";
	data->menu_texture[3].pos_text = (t_dot){.x = 600, .y = 700};
	data->menu_state = 1;
	i = -1;
	while (++i < 4)
	{
		if (!(data->menu_texture[i].img.addrs =
		...
		(int *)mlx_get_data_addr(data->menu_texture[i].img.addrs,
		&(data->menu_texture[i].img.bpp),
...
int		shield_texture_animation(t_data *data)
{
	...
	data->shieldanim.tab_texture[0] = "hud/images/shieldanim1.xpm";
	data->shieldanim.tab_texture[1] = "hud/images/shieldanim2.xpm";
	data->shieldanim.tab_texture[2] = "hud/images/shieldanim3.xpm";
	data->shieldanim.tab_texture[3] = "hud/images/shieldanim4.xpm";
	i = -1;
	while (++i < NB_ANIM_TEX)
	{
		if (!(data->shieldanim.anim_texture[i].img.addrs =
		...
		(int *)mlx_get_data_addr(data->shieldanim.anim_texture[i].img.addrs,
		&(data->shieldanim.anim_texture[i].img.bpp),
